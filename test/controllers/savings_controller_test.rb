...
class SavingsControllerTest < ActionController::TestCase
  ...
  test "should create saving" do
    assert_difference('Saving.count') do
      post :create, saving: { AddedDate: @saving.AddedDate, AddedSaving: @saving.AddedSaving, DrawerID: @saving.DrawerID }
    end
  ...
  test "should update saving" do
    patch :update, id: @saving, saving: { AddedDate: @saving.AddedDate, AddedSaving: @saving.AddedSaving, DrawerID: @saving.DrawerID }
    assert_redirected_to saving_path(assigns(:saving))
  end
